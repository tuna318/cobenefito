...
ActiveRecord::Schema.define(version: 20_211_109_043_436) do
  create_table "claim_point_requests", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                       force: :cascade do |t|
    t.string "title"
  ...
  create_table "coupon_transactions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                      force: :cascade do |t|
    t.integer "price"
    t.integer "buyer_id"
    t.integer "seller_id"
  ...
  create_table "coupons", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                          force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.string "usuable_at"
  ...
  create_table "spaces_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                               force: :cascade do |t|
    t.string "username"
